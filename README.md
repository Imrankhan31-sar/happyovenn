# The Happy Oven by Altafa

Responsive, single-page bakery site built with plain HTML, CSS and JavaScript. Open `index.html` in a browser to view it.

## Editing the site

- Update product names, descriptions, images and categories in `script.js` under `PRODUCTS`.
- Update WhatsApp, phone, Instagram and pickup details in the `BAKERY` object near the top of `script.js`.
